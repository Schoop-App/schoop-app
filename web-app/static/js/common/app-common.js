...
document.addEventListener("DOMContentLoaded", async () => {
	...
	if (typeof STUDENT_HAS_SEEN_ONBOARDING !== "undefined" && !STUDENT_HAS_SEEN_ONBOARDING) {
		...
		let onboardingDialog = await Swal.fire({
			...
			<p>Welcome to Schoop! We hope that you find this app useful in organizing yourself during virtual learning.</p><p>There are currently three pages of interest: <strong>home</strong> (house icon), the <strong>profile</strong> page (person icon), and <strong>calendar</strong> (the calendar icon).</p><p>On the <strong>home page</strong>, you'll find your interactive, clickable schedule for the day as well as an indicator of what the current event is and what is up next.</p><p>On the <strong>profile page</strong>, you can edit your class list and change other preferences. You can also, if you wish, delete your account on this page.</p><p>The <strong>calendar page</strong> will show you events from your Google Calendar. Select events and click "Add to account" and they will appear in your today view.</p><p><strong>If you have any feedback or concerns, feel free to click the comment icon in the top bar to do so.</strong> You will be presented with a Google Form in which you can let us know of what you think.</p><p>Please <a href="https://blog.schoop.app/contact.html" target="_blank">reach out to us</a> if you have any other questions. Thank you for using Schoop!</p><div><label for="userDoesNotWantToSeeOnboardingAgainCheckbox" style="font-style:italic;">Don't show this to me again&nbsp;&nbsp;</label><input type="checkbox" id="userDoesNotWantToSeeOnboardingAgainCheckbox" checked/></div></div>`
		});
